...
import { TrainingProgramReview } from '@/components/training/TrainingProgramReview';
...
export default function AMLTraining() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Training Program</h1>
        <p className="text-muted-foreground mt-1">
          Assess AML training program design, delivery, and effectiveness
        </p>
      </div>
      ...
      <div className={cn(
        ...
        <TrainingProgramReview engagementId={selectedEngagement.id} />
      </div>
    </div>
  );
}
